...
const deleteSelected = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.visit(route("variations.delete_selected"), {
                method: "post",
                data: {
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    ...
                                    v-for="variate in variations.data"
                                    :key="variate.id"
                                >
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ variate.name[$page.props.locale] }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{
                                            moment(variate.created_at).format(
                                                "MMM DD, YYYY"
                                            )
                                        }}
                                    </td>
                    ...
                    <Pagination :pages="variations.links" />
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
